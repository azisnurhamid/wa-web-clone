        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {lockoutTime ? (
            <div className="text-center py-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">{TEXTS.dashboard.login.blocked}</h3>
              <p className="text-sm text-gray-500">
                Anda telah salah memasukkan password lebih dari 3 kali.
                <br />
                Silakan coba lagi dalam:
                <br />
                <span className="font-bold text-red-600 text-lg mt-2 block">{remainingTimeText}</span>
              </p>
            </div>
          ) : (
