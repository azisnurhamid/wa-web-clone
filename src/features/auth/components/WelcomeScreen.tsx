    ...
    <div className="h-screen w-full bg-white flex flex-col relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        <div className="w-[240px] h-[240px] mb-4 flex items-center justify-center">
          <svg viewBox="0 0 300 300" className="w-full h-full">
            ...
            <g transform="translate(55, 60)">
              <path
                d="M25 5 C15 0, 5 8, 10 18 C15 28, 22 25, 25 22 C28 19, 32 22, 30 28 C28 34, 18 38, 8 28 C-2 18, 0 5, 10 0 C15 -3, 22 0, 25 5Z"
                fill="#25D366"
                stroke="#128C7E"
                strokeWidth="1.5"
              />
            ...
            <g transform="translate(75, 195)">
              <path
                d="M12 4C12 4 8 0 5 0C2 0 0 2 0 5C0 8 3 11 12 18C21 11 24 8 24 5C24 2 22 0 19 0C16 0 12 4 12 4Z"
                fill="#25D366"
              />
            </g>
            <g transform="translate(180, 200)">
              ...
              <path
                d="M8 12V8C8 4.5 10.5 2 14 2C17.5 2 20 4.5 20 8V12"
                fill="none"
                stroke="#25D366"
                strokeWidth="2.5"
                strokeLinecap="round"
        ...
        <p className="text-[14.5px] text-[#667781] text-center leading-[22px] max-w-[320px]">
          ...
          <span className="text-[#008069] cursor-pointer hover:underline">
